          ...
          @endif  
           ...
           @if( isPluginActive('user') )
            ...
            @if( isPluginActive(['quick_notification', 'Sendsms']) )
                <li class="treeview Lo-left-sidebar {{ ( in_array( $request->segment(1), array( 'internal_notifications' ) ) || ( in_array($controller, array('SendSmsController') ) && in_array($action, array('index', 'create', 'edit', 'show', 'destroy') ) ) ) ? 'active' : '' }}">
                    <a href="#">
            ...
            @if( isPluginActive( ['support', 'faq'] ) )
                ...
                <li class="treeview Lo-left-sidebar {{ ( in_array( $request->segment(1), array( 'support' ) ) || in_array( $request->segment(2), array(  'articles', 'faq_questions', 'faq_categories' ) ) ) ? 'active' : '' }}">
                    <a href="#">
                        <i class="fa fa-building-o"></i>
            ...
            <li class="treeview Lo-left-sidebar">
                ...
                <ul class="treeview-menu">
                    ...
                    @if( File::exists(config('modules.paths.modules') . '/DynamicOptions') && Module::find('dynamicoptions') && isPluginActive('dynamicoptions'))
                    ...
                    @if( File::exists(config('modules.paths.modules') . '/DatabaseBackup') && Module::find('databasebackup') && isPluginActive('databasebackup'))
                    ...
                    {{--
                    @if( File::exists(config('modules.paths.modules') . '/SiteThemes') && Module::find('sitethemes') && isPluginActive('sitethemes'))
            ...
            @if( File::exists(config('modules.paths.modules') . '/ModulesManagement') && Module::find('modulesmanagement') && isPluginActive('modulesmanagement'))
                @can('modules_management_access')
                <li class=" Lo-left-sidebar {{ ( in_array($controller, array('ModulesManagementsController') ) && in_array($action, array('index', 'create', 'edit', 'show') ) ) ? 'active' : '' }}">
            ...
            <li class=" Lo-left-sidebar {{ $request->segment(2) == 'messenger' ? 'active' : '' }} {{ ($unread > 0 ? 'unread' : '') }}">

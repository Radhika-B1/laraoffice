...
<li role="presentation" class="{{$tabs['contacts_active']}}"><a href="{{route('admin.contact_groups.show', [ $contact_group->id,'list'=>'contact' ])}}" title="@lang('global.contacts.title')">@lang('global.contacts.title')</a></li>
</ul>

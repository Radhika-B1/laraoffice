...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('contacts', function (Blueprint $table) {
            ...
            $table->string('phone1_code', 5)->nullable();
            $table->string('phone1')->nullable();
            $table->string('phone2_code', 5)->nullable();
            ...
            $table->char('theme', 10)->nullable();
            $table->char('portal_language', 10)->nullable();
            $table->string('confirmation_code')->nullable();
            $table->string('last_login_from', 50)->nullable();
            $table->double('hourly_rate')->nullable()->default(0);
            $table->enum('is_user', ['yes', 'no'])->nullable()->default('no');
            $table->string('color_theme', 45)->nullable();

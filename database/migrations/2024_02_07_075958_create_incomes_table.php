    ...
    public function up()
    {
        Schema::create('incomes', function (Blueprint $table) {
           ...
           $table->timestamp('created_at')->nullable()->default(NULL);
            ...
            $table->string('payer_name', 45)->nullable()->comment('If the contact is deleted we can use this name, so that admin have track on all incomes even when contact deleted');
            $table->string('pay_method_id')->nullable()->index('259288_5c5007230da07');
        });
    }

...
class PaymentGatewaysController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $transfers = \App\Models\Transfer::where('payment_method_id', $id)->get();$incomes = \App\Models\Income::where('pay_method_id', $id)->get();$expenses = \App\Models\Expense::where('payment_method_id', $id)->get();
